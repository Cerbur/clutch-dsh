...
本包包含 Host 和 browser 入口，peer DSH 下界为 `>=0.1.7-rc.1`；发布前必须验证 disable default + insert custom 的 patch composition、browser bundle 和 settings 模板管理，npm pack 只能在 release worktree 执行。
