...
import { sessionLabel } from '../selectors.js';
import type {
...
function sessionHoverTimeLabel(t: WorktreeSessionRowProps['t'], value: RelativeTime): string {
              ...
              items={[
                ...
                ...(menu.onAdoptBranch
                  ? [
                      {
                        id: 'adopt-branch',
                        label: t('worktree.adoptBranch'),
                        disabled: menu.disabled,
                      },
                    ]
                  : []),
                ...(menu.onRecover
                  ? [{ id: 'recover', label: t('worktree.retryRecovery'), disabled: menu.disabled }]
                  : []),
                ...(menu.showUnarchive
                  ? [
                      {
                        ...
                        disabled:
                          menu.disabled || menu.unarchiveDisabled || menu.onUnarchive === undefined,
                      },
                    ]
                  : []),
                ...(menu.showCleanDisk
                  ? [
                      {
                        ...
                        danger: true,
                        disabled:
                          menu.disabled || menu.cleanDiskDisabled || menu.onCleanDisk === undefined,
                      },
                    ]
                  : []),
                ...(menu.showForget
                  ? [
                      {
                        ...
                        danger: true,
                        disabled:
                          menu.disabled || menu.forgetDisabled || menu.onForget === undefined,
                      },
                    ]
                  : []),
              ]}
