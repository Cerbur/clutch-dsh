...
export const zh = {
  ...
  'worktree.cleaned': '磁盘已清理',
  'worktree.archivedGroup': '已归档',
  'worktree.cleanDisk': '清理磁盘',
  'worktree.cleanDiskTitle': '清理 Worktree 磁盘',
  'worktree.cleanDiskDescription': '从磁盘删除“{name}”（{path}）？此操作不可逆。插件不会检查 Session 或子代理是否正在运行，请自行确认所有使用此目录的任务均已停止；否则删除可能导致任务失败或数据丢失。关联 Session 与历史会保留，但此目录将不可用。',
