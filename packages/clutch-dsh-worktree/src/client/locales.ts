...
export const zh = {
  ...
  'dashboard.git.baselineUnknownDescription': '此 Worktree 创建于 baseline 跟踪接入之前，无法安全确定原始比较点。',
  'dashboard.git.mainUnavailableTitle': '本地 Workspace 不适用',
  'dashboard.git.mainUnavailableDescription': 'Git Dashboard 只展示已登记 Worktree 相对于 acquisition baseline 的提交。',
  ...
  'dashboard.statusHint': "目录可用性来自现有检查；Git 与变更页展示 acquisition baseline 之后的提交，并在顶部显示当前未提交的工作区改动。",
  ...
  'dashboard.hint.git': "这里展示相对于 acquisition baseline 的提交、当前未提交的工作区改动、变更文件和统一 Diff。",
...
export const en = {
  ...
  'dashboard.git.baselineUnknownDescription': 'This Worktree predates baseline tracking, so its original comparison point cannot be determined safely.',
  'dashboard.git.mainUnavailableTitle': 'Not available for the local Workspace',
  'dashboard.git.mainUnavailableDescription': 'The Git Dashboard shows commits for a registered Worktree relative to its acquisition baseline.',
  ...
  'dashboard.statusHint': "Availability comes from existing checks; Git & Changes shows commits after the acquisition baseline and current uncommitted work at the top.",
  ...
  'dashboard.hint.git': "View commits and current uncommitted work, plus changed files and unified diffs relative to the acquisition baseline.",
