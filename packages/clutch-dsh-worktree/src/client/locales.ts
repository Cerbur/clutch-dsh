...
export const zh = {
  ...
  'dashboard.git.loading': '正在加载 Git 历史…',
  ...
  'dashboard.git.noFiles': '此提交没有可显示的变更文件。',
  'dashboard.git.selectCommit': '选择一个提交查看详情。',
  ...
  'dashboard.statusHint': "目录可用性来自现有检查；Git 与变更页展示 acquisition baseline 之后的提交。",
  ...
  'dashboard.hint.git': "这里展示相对于 acquisition baseline 的提交、变更文件和统一 Diff。",
...
export const en = {
  ...
  'dashboard.git.loading': 'Loading Git history…',
  ...
  'dashboard.git.noFiles': 'This commit has no displayable changed files.',
  'dashboard.git.selectCommit': 'Select a commit to view its details.',
  ...
  'dashboard.statusHint': "Availability comes from existing checks; Git & Changes shows commits after the acquisition baseline.",
  ...
  'dashboard.hint.git': "View commits, changed files, and unified diffs relative to the acquisition baseline.",
