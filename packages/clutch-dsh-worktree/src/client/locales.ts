...
export const zh = {
  ...
  'dashboard.noInstructions': "Worktree 指令尚未接入",
  'dashboard.instructionsHint': "这里将用于查看和编辑工作指引。当前不会保存或注入任何指令。",
  'dashboard.sessionsHint': "会话面板待接入。你可以继续从左侧 Worktree 列表打开会话。",
  ...
  'dashboard.hint.sessions': "这里将管理属于此 Worktree 的会话。当前请从左侧列表打开或新建会话。",
  'dashboard.hint.children': "这里将展示基于此 Worktree 派生的工作目录与关系。",
  'dashboard.hint.settings': "这里将提供 Worktree 指令与偏好设置。当前不会保存任何更改。",
  'dashboard.mvpHint': "MVP · 名称、cwd 和 tab 切换已接入；标记为“即将推出”的操作暂不可用。",
...
export const en = {
  ...
  'dashboard.noInstructions': "Instructions are not connected yet",
  'dashboard.instructionsHint': "View and edit worktree guidance here in a future update. Nothing is saved or injected yet.",
  'dashboard.sessionsHint': "The session panel is coming soon. Open existing sessions from the Worktree sidebar.",
  ...
  'dashboard.hint.sessions': "Sessions for this worktree will appear here. Use the sidebar to open or create a session for now.",
  ...
  'dashboard.mvpHint': "MVP · Name, cwd, and tabs are connected. Actions marked Coming soon are unavailable.",
