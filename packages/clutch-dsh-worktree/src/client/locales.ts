...
export const zh = {
  ...
  'dashboard.git.baselineSummaryDescription': '查看基线到 HEAD 的全部已提交变更（默认不含工作区）。',
...
export const en = {
  ...
  'dashboard.git.baselineSummaryDescription': 'View all committed changes from the baseline to HEAD (excluding the working tree by default).',
