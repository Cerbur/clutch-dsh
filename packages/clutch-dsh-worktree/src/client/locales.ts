...
export const zh = {
  ...
  'dashboard.statusHint': "目录可用性来自现有检查；选择 branch 基线后，Git 与变更页展示其之后的提交，并在顶部显示当前未提交的工作区改动。",
  ...
  'dashboard.hint.git': "这里展示相对于所选 branch 基线的提交、当前未提交的工作区改动、变更文件和统一 Diff。",
...
export const en = {
  ...
  'dashboard.statusHint': "Availability comes from existing checks; after you choose a branch baseline, Git & Changes shows later commits and current uncommitted work at the top.",
  ...
  'dashboard.hint.git': "View commits and current uncommitted work, plus changed files and unified diffs relative to the selected branch baseline.",
