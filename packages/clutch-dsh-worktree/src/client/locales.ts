...
export const zh = {
  ...
  'worktree.cleanDiskDescription': '从磁盘删除“{name}”（{path}）？此操作不可逆。关联 Session 会保留在 DSH 中，并作为已分离关系继续可用。',
...
export const en = {
  ...
  'worktree.cleanDiskDescription': 'Delete {name} ({path}) from disk? This operation cannot be undone. Linked Sessions stay in DSH and remain available as detached bindings.',
