...
export const zh = {
  ...
  'dashboard.instructions': "Worktree / Main 指令",
  'dashboard.edit': "编辑",
  'dashboard.instructionsDescription': "为这个 Worktree 或 Main Workspace 设置共享的工作指引。",
  'dashboard.noInstructions': "尚未设置指令",
  'dashboard.instructionsHint': "最多 32,000 字符。保存后在这个 Worktree 或 Main Workspace 中运行的会话下一次模型请求中以 <system-reminder> 生效；清空并保存可停用。",
...
export const en = {
  ...
  'dashboard.instructions': "Worktree / Main Instructions",
  'dashboard.edit': "Edit",
  'dashboard.instructionsDescription': "A place for shared guidance for this Worktree or Main Workspace.",
  'dashboard.noInstructions': "No instructions yet",
  'dashboard.instructionsHint': "Up to 32,000 characters. Saved instructions enter the next model request for Sessions using this Worktree or Main Workspace as <system-reminder>. Clear and save to disable.",
