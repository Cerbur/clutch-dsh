...
- [x] **Step 5: Add the observing hook and use the bounds in the surface.**
...
- [x] **Step 6: Add the focused source assertions and run them.**
...
- [x] **Step 2: Run the focused composition test and verify RED.**
...
- [x] **Step 3: Implement the four thin callback injections.**
...
- [x] **Step 1: Write failing Workspace parity source tests.**
...
- [x] **Step 2: Run the Workspace parity test and verify RED.**
...
- [x] **Step 3: Add Workspace drag state and commit logic.**
...
- [x] **Step 4: Add Workspace rename/delete dialog state.**
...
- [x] **Step 5: Render the focused Workspace row component.**
...
- [x] **Step 7: Commit the Workspace row slice.**
...
- [x] **Step 2: Run the Session behavior test and verify RED.**
...
- [x] **Step 3: Add group-scoped Session drag state.**
...
- [x] **Step 4: Add the five-row limit and expand/collapse control.**
...
- [x] **Step 5: Convert Session row rendering to native-style drag markup.**
...
- [x] **Step 6: Run the focused Session tests and verify GREEN.**

Run the same test command. Expected: Session drag, expand-more, and no-bound
assertions pass.

- [x] **Step 7: Commit the Session slice.**
...
- [x] **Step 2: Run health tests and verify RED.**
...
- [x] **Step 3: Add the optional transient contract field and persistence strip.**
...
- [x] **Step 4: Derive health in Manage.**
...
- [x] **Step 5: Render native state dots.**
...
- [x] **Step 6: Run health tests and verify GREEN.**

Run the same test command. Expected: all health, Remote, sidecar, and existing
Manage tests pass.

- [x] **Step 7: Commit the health slice.**
...
- [x] **Step 2: Run the final layout test and verify RED.**
...
- [x] **Step 3: Remove the mode switch and unify action columns.**
...
- [x] **Step 4: Make the computed content interval scroll.**
...
- [x] **Step 5: Run the full Client surface test file.**
...
- [x] **Step 6: Commit the integrated Client slice.**
...
- [x] **Step 1: Update the Client documentation.**
...
- [x] **Step 2: Mark completed plan steps with exact verification commands.**
...
- [x] **Step 3: Run focused package checks.**
...
- [x] **Step 4: Run repository checks appropriate to the changed package.**
...
- Arc acceptance — passed after refreshing the local bundle: dynamic overlay
  starts below the actual native New Session control and ends above the native
  footer; native collapse/rail works; Workspace and Session menus/dialogs open;
  Expand more/Collapse works; active Worktree shows a green ready dot. Delete
  confirmations were opened and cancelled without mutating data.
- Native DSH scope — checked with `git -C
  /Users/yuancheng/Documents/Code/deepseek-harness status --short` and `git -C
