...
- 将 Overview 中的基线编辑改为铅笔图标入口和 DSH 原生弹窗，支持搜索过滤本地 branch 后保存。
...
- Replace the Overview baseline editor with a pencil-icon trigger and a native DSH dialog that filters local branches as you search before saving.
