...
- When the current Session is outside the visible tree, the matching row is highlighted and temporarily revealed; this does not change persisted expansion choices.
